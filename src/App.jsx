...
const TASKS = [
    ...
    },
    {
        ...
        taskLink: 'https://t.me/bidask_gm/26895',
        instructions: [
    ...
    },
    {
        ...
        copyableTexts: [
            ...
            "Желаю в новом году, чтобы твой профит рос быстрее, чем TVL в экосистеме TON, а Bidask всегда радовал лучшим исполнением.\nВстретимся на иксах в 2026-м! 🚀💎",
            "May your 2026 be filled with low slippage and high returns. Stop chasing green candles and start making smart moves with Bidask.🚀💎",
    ...
    },
    {
        ...
        taskLink: 'https://bidask.finance/en/app/pools',
    ...
    },
    {
        ...
        taskLink: 'https://x.com/BidaskProtocol',
        instructions: [
            ...
            <div className="app">
                <div className="header">
                    ...
                    <p style={{ marginTop: '1rem', color: 'var(--text-secondary)' }}>
                        Долго грузим, пора сбивать сосульки с проводов
                    </p>
                </div>
            </div>
        )
